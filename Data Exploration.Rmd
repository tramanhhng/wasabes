...
Upon further exploration, we create a function to process the data into a suitable dataframe.   

* We start by cleaning the rows with the "#" symbol. A total of 5313 rows are removed, resulting in 146,079 rows.  
...
#remove top rows 
#clean_offline = clean_offline[-3] #?why delete row 3?
#looking good
#head(clean_offline)
#We have rows! =)
